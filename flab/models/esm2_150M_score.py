...
from esm2_150M_model import esm2_150M_score
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Score antibody sequences with ESM2 150M pseudo-perplexity.")
