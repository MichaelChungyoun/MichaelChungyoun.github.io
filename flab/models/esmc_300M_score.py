...
from esmc_300M_model import esmc_300M_score
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Score antibody sequences with ESM-C 300M pseudo-perplexity.")
