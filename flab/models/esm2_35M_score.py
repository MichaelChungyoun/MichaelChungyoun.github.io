...
from esm2_35M_model import esm2_35M_score
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Score antibody sequences with ESM2 35M pseudo-perplexity.")
