...
from esmc_600M_model import esmc_600M_score
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Score antibody sequences with ESM-C 600M pseudo-perplexity.")
