...
from antiberty_model import antiberty_pseudoppl
...
def safe_score(seq):
    if pd.isna(seq) or str(seq).strip() == "":
        return np.nan
    try:
        return antiberty_pseudoppl(seq)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Score antibody sequences with AntiBERTy pseudo-perplexity.")
