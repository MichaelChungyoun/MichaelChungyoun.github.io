...
from esm2_8M_model import esm2_8M_score
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Score antibody sequences with ESM2 8M pseudo-perplexity.")
